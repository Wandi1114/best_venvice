...
exports.main = async ()=>{
    ...
    return transporter = await nodemailer.createTransport({
      ...
      auth:{
        type:"OAuth2",
        user:"venviceindonesia@gmail.com",
        clientId:CLIENT_ID,
...
exports.verifyEmail = async (email,otp) => {
    ...
    let infor = await transporter.sendMail({
        from : "Venvice Indonesia <noreply@gmail.com>",
        to : email,
        subject : "Kode Aktivasi Akun anda adalah ...",
        html : "<bold>"+otp+"</bold>"
    });
...
exports.LupaPassword = async (email, token) => {
    // let transporter = await
}
...
//     html : "<button><a href=''> KLIK DISINI <a><button>"
// };
